...
export default function Home() {
  ...
  return (
    <div className={`bganimate bg-size-[150%] bg-linear-to-br from-secondary from-30% to-tertiary bg-no-repeat bg-secondary flex flex-col items-center justify-center w-full  min-h-dvh py-2`}>
